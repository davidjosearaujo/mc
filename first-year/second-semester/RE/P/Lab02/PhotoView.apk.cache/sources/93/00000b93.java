...
final class e {
    ...
    public static String a(CharSequence charSequence, int i) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            int charAt = (charSequence.charAt(i2) + cArr[a2 - 1]) % 929;
            for (int i3 = a2 - 1; i3 > 0; i3--) {
                cArr[i3] = (char) (((929 - ((f658a[i][i3] * charAt) % 929)) + cArr[i3 - 1]) % 929);
            }
            cArr[0] = (char) ((929 - ((f658a[i][0] * charAt) % 929)) % 929);
        }
