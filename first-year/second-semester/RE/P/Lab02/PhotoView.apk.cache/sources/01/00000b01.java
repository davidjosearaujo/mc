...
public final class n {
    ...
    public static final o<Class> f579a = new o<Class>() { // from class: com.google.gson.internal.a.n.1
    ...
    public static final p b = a(Class.class, f579a);
    public static final o<BitSet> c = new o<BitSet>() { // from class: com.google.gson.internal.a.n.12
        ...
        public BitSet b(com.google.gson.stream.a aVar) {
            ...
            while (f2 != JsonToken.END_ARRAY) {
                switch (AnonymousClass29.f586a[f2.ordinal()]) {
                    case 1:
                        if (aVar.m() == 0) {
                            z2 = false;
                            break;
    ...
    public static final o<AtomicInteger> n = new o<AtomicInteger>() { // from class: com.google.gson.internal.a.n.34
        ...
        @Override // com.google.gson.o
        public void a(com.google.gson.stream.b bVar, AtomicInteger atomicInteger) {
    ...
    public static final o<AtomicBoolean> p = new o<AtomicBoolean>() { // from class: com.google.gson.internal.a.n.35
        ...
        @Override // com.google.gson.o
        public void a(com.google.gson.stream.b bVar, AtomicBoolean atomicBoolean) {
    ...
    public static final o<AtomicIntegerArray> r = new o<AtomicIntegerArray>() { // from class: com.google.gson.internal.a.n.2
        ...
        @Override // com.google.gson.o
        public void a(com.google.gson.stream.b bVar, AtomicIntegerArray atomicIntegerArray) {
            bVar.b();
    ...
    public static final o<Currency> Q = new o<Currency>() { // from class: com.google.gson.internal.a.n.18
        ...
        @Override // com.google.gson.o
        public void a(com.google.gson.stream.b bVar, Currency currency) {
    ...
    public static final o<com.google.gson.i> X = new o<com.google.gson.i>() { // from class: com.google.gson.internal.a.n.22
        ...
        public com.google.gson.i b(com.google.gson.stream.a aVar) {
            switch (AnonymousClass29.f586a[aVar.f().ordinal()]) {
                case 1:
                ...
                case 4:
                    aVar.j();
                    return com.google.gson.j.f612a;
                case 5:
        ...
        @Override // com.google.gson.o
        public void a(com.google.gson.stream.b bVar, com.google.gson.i iVar) {
            if (iVar == null || iVar.j()) {
                bVar.f();
            } else if (iVar.i()) {
    ...
    private static final class a<T extends Enum<T>> extends o<T> {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final Map<String, T> f587a = new HashMap();
            ...
            try {
                for (T t : cls.getEnumConstants()) {
                    ...
                    if (cVar != null) {
                        ...
                        String[] b = cVar.b();
                        for (String str : b) {
                            this.f587a.put(str, t);
                        }
                    }
                    String str2 = name;
                    this.f587a.put(str2, t);
                    this.b.put(t, str2);
                }
            ...
            public <T2> o<T2> a(com.google.gson.d dVar, com.google.gson.b.a<T2> aVar) {
                ...
                if (cls.isAssignableFrom(a2)) {
                    return (o<T2>) new o<T1>() { // from class: com.google.gson.internal.a.n.28.1
                        @Override // com.google.gson.o
                        public void a(com.google.gson.stream.b bVar, T1 t1) {
                            oVar.a(bVar, t1);
                        }
