...
.method a()V
    ...
    .line 64
    iget-wide v4, p0, Lcom/facebook/n;->d:J

    .line 65
    iget-wide v6, p0, Lcom/facebook/n;->f:J

    .line 66
    check-cast v3, Lcom/facebook/GraphRequest$e;

    .line 68
    iget-object v0, p0, Lcom/facebook/n;->b:Landroid/os/Handler;
    ...
    new-instance v1, Lcom/facebook/n$1;

    move-object v2, p0

    invoke-direct/range {v1 .. v7}, Lcom/facebook/n$1;-><init>(Lcom/facebook/n;Lcom/facebook/GraphRequest$e;JJ)V
...
.method a(J)V
    ...
    .line 51
    :cond_0
    invoke-virtual {p0}, Lcom/facebook/n;->a()V
