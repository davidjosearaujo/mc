...
public final class C$Gson$Types {
    ...
    static final Type[] f553a = new Type[0];
    ...
    public static WildcardType b(Type type) {
        return new WildcardTypeImpl(new Type[]{type}, f553a);
    }
    ...
    public static final class WildcardTypeImpl implements Serializable, WildcardType {
        ...
        public Type[] getLowerBounds() {
            return this.lowerBound != null ? new Type[]{this.lowerBound} : C$Gson$Types.f553a;
        }
