...
class g {
    ...
    /* loaded from: classes.dex */
    static abstract class a extends w.a {
        ...
        protected a(byte[] bArr) {
            if (bArr.length != 25) {
                ...
                String valueOf = String.valueOf(com.google.android.gms.common.util.i.a(bArr, 0, bArr.length, false));
                ...
                com.google.android.gms.common.internal.c.b(bArr.length == 25, new StringBuilder(55).append("cert hash data has incorrect length. length=").append(bArr.length).toString());
            }
            this.f413a = Arrays.hashCode(bArr);
        }
        ...
        public boolean equals(Object obj) {
            ...
            try {
                w wVar = (w) obj;
                if (wVar.b() == hashCode() && (a2 = wVar.a()) != null) {
                    return Arrays.equals(c(), (byte[]) com.google.android.gms.dynamic.b.a(a2));
                }
                return false;
    ...
    static abstract class c extends a {
        ...
        /* renamed from: a  reason: collision with root package name */
        private WeakReference<byte[]> f415a;
        ...
        byte[] c() {
            ...
            synchronized (this) {
                ...
                if (bArr == null) {
                    bArr = d();
                    this.f415a = new WeakReference<>(bArr);
                }
            }
            return bArr;
        }
    ...
    static final class d {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final a[] f416a = {new c(a.a("0\u0082\u0004C0\u0082\u0003+ \u0003\u0002\u0001\u0002\u0002\t\u0000Âà\u0087FdJ0\u008d0")) { // from class: com.google.android.gms.common.g.d.1
            @Override // com.google.android.gms.common.g.c
            protected byte[] d() {
        ...
        }, new c(a.a("0\u0082\u0004¨0\u0082\u0003\u0090 \u0003\u0002\u0001\u0002\u0002\t\u0000Õ\u0085¸l}ÓNõ0")) { // from class: com.google.android.gms.common.g.d.2
            @Override // com.google.android.gms.common.g.c
            protected byte[] d() {
