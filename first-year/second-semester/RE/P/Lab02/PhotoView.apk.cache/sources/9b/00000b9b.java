...
final class e {
    ...
    private static final int[][] f664a = {new int[]{1, 1, 1, 1, 1, 1, 1}, new int[]{1, 0, 0, 0, 0, 0, 1}, new int[]{1, 0, 1, 1, 1, 0, 1}, new int[]{1, 0, 1, 1, 1, 0, 1}, new int[]{1, 0, 1, 1, 1, 0, 1}, new int[]{1, 0, 0, 0, 0, 0, 1}, new int[]{1, 1, 1, 1, 1, 1, 1}};
    ...
    public static void a(com.google.zxing.common.a aVar, ErrorCorrectionLevel errorCorrectionLevel, com.google.zxing.qrcode.decoder.a aVar2, int i, b bVar) {
        a(bVar);
        a(aVar2, bVar);
    ...
    static void a(com.google.zxing.common.a aVar, int i, b bVar) {
        int i2;
        int i3;
        int i4;
        int i5;
        ...
        if (i7 != aVar.a()) {
            throw new WriterException("Not all bits consumed: " + i7 + '/' + aVar.a());
        }
    }
    ...
    static void a(ErrorCorrectionLevel errorCorrectionLevel, int i, com.google.zxing.common.a aVar) {
        if (!f.b(i)) {
    ...
    static void a(com.google.zxing.qrcode.decoder.a aVar, com.google.zxing.common.a aVar2) {
        aVar2.a(aVar.a(), 6);
    ...
    private static void d(int i, int i2, b bVar) {
        for (int i3 = 0; i3 < 7; i3++) {
            for (int i4 = 0; i4 < 7; i4++) {
                bVar.a(i + i4, i2 + i3, f664a[i3][i4]);
            }
        }
    }

    private static void d(b bVar) {
        int length = f664a[0].length;
        d(0, 0, bVar);
