...
public final class i {
    ...
    private static final int[] f640a = {5, 7, 10, 11, 12, 14, 18, 20, 24, 28, 36, 42, 48, 56, 62, 68};
    ...
    public static String a(String str, k kVar) {
        ...
        if (a2 == 1) {
            ...
            for (int i2 = 0; i2 < a2; i2++) {
                ...
                for (int i3 = i2; i3 < kVar.f(); i3 += a2) {
                    sb2.append(str.charAt(i3));
                }
                String a3 = a(sb2.toString(), iArr2[i2]);
                int i4 = i2;
                int i5 = 0;
                while (i4 < iArr2[i2] * a2) {
                    sb.setCharAt(kVar.f() + i4, a3.charAt(i5));
                    i4 += a2;
                    i5++;
                }
            }
