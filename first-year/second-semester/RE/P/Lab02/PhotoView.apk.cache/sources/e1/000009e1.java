...
public final class n {
    ...
    private static final SimpleArrayMap<String, String> f442a = new SimpleArrayMap<>();
    ...
    public static String a(Context context) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            try {
                return com.google.android.gms.internal.v.b(context).a(context.getPackageName()).toString();
    ...
    private static String a(Context context, String str) {
        synchronized (f442a) {
            String str2 = f442a.get(str);
            if (str2 != null) {
                return str2;
            }
            Resources a2 = com.google.android.gms.common.c.a(context);
            if (a2 == null) {
                return null;
            }
    ...
    public static String c(Context context, int i) {
        ...
        switch (i) {
            ...
            case 2:
                return com.google.android.gms.common.util.g.b(context) ? resources.getString(R.string.common_google_play_services_wear_update_text) : resources.getString(R.string.common_google_play_services_update_text, a2);
            case 3:
